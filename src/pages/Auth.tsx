...
const Auth = () => {
  ...
  return (
    <MainLayout>
      <div className="flex items-center justify-center min-h-screen bg-transparent px-2">
        <Card className="w-full max-w-md border-[#999266]/20 bg-black/60 backdrop-blur-md shadow-lg">
...
// NOTE: This file is now very long; consider refactoring it into smaller components for maintainability.
